...
public class NewAssignee {
	...
	public static WebElement waitForElementToBeClickable(WebDriver driver,WebElement webElement,int seconds)
	 ...
	 public static WebElement ccid(WebDriver driver){
		...
		public static WebElement clientsystemid(WebDriver driver){
		 ...
		 public static Select authorizefor(WebDriver driver){
			 Select element = null; 
			 WebElement element_dropdown = driver.findElement(By.xpath("//select[@id='ddlb_Authorizefor']"));
		      element=new Select (element_dropdown);
			  return element;
		  }
		
		 public static WebElement employeeportalinfo(WebDriver driver){
				element =     driver.findElement(By.xpath("//a[contains(.,'Employee Portal Info')]"));
				return element;
				}	
		 
		 public static void EmployeePortalClick(WebDriver driver) {
			   element = employeeportalinfo(driver);
			   waitForElementToBeClickable(driver,element,3);
			   element.click();
		}
		
		 
		 public static WebElement dmodclose(WebDriver driver){
				element =     driver.findElement(By.xpath("//*[@id='did_modbox_closer_1']"));
				return element;
				}	
		 
		 public static void DmodcloseClick(WebDriver driver) {
			   element = dmodclose(driver);
			   waitForElementToBeClickable(driver,element,3);
			   element.click();
		}
	...
	//**3M PROFILE**//
	 ...
	 public static WebElement orgresultAB(WebDriver driver){
		  element =  	 driver.findElement((By.xpath("//a[contains(.,'Alliance Bernstein LP')]")));
		  return element;
	  }
	 
	 public static void OrgResultABClick(WebDriver driver) {
		   element = orgresultAB(driver);
		   waitForElementToBeClickable(driver,element,3);
		   element.click();
	}
