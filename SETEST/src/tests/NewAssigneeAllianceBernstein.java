...
public class NewAssigneeAllianceBernstein {
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/ALLIANCEBERNSTEIN-PROFILE-Screenshots/" + screenshotname + ".png"));
		} catch (Exception e) {
...
//		    driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
	...
	public void test() throws Exception {
		...
		(new WebDriverWait(driver, 2)).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
		...
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top"));
		NewAssignee.orgname(driver).sendKeys("Alliance Bernstein");
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
		driver.switchTo().parentFrame();
		...
		NewAssignee.OrgResultABClick(driver);
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
		driver.switchTo().parentFrame();
		driver.switchTo().parentFrame();
		driver.switchTo().parentFrame();
		...
		Thread.sleep(1500);
		takeScreenshot(driver, "3.AB Profile1");
		...
		Thread.sleep(1500);
		takeScreenshot(driver, "4. AB Profile2");
		...
		Thread.sleep(1500);
		takeScreenshot(driver, "5.AB Profile3");
		...
		Thread.sleep(3000);
		takeScreenshot(driver, "6.AB Profile Completed");
		...
		actions.perform();
		takeScreenshot(driver, "7.AB Profile Completed");
		Thread.sleep(1500);
		...
		actions1.perform();
		takeScreenshot(driver, "8.AB Profile Completed");
		Thread.sleep(1500);
		...
		actions2.perform();
		takeScreenshot(driver, "9.AB Profile Completed");
		Thread.sleep(1500);
		...
		actions3.perform();
		takeScreenshot(driver, "10.AB Profile Completed");
		Thread.sleep(1500);
		...
		actions4.perform();
		takeScreenshot(driver, "11.AB Profile Completed");
		Thread.sleep(1500);
