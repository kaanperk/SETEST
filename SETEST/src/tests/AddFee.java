...
//		    driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
	...
	public void test() throws Exception {
		...
		(new WebDriverWait(driver, 2)).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("summaryButtons"));
		...
		(new WebDriverWait(driver, 2)).until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@id='DebitAccount_TextBoxMaster']")));
