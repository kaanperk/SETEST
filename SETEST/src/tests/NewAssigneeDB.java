...
public class NewAssigneeDB {
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/DBProfile-Screenshots/" + screenshotname + ".png"));
		} catch (Exception e) {
	 ...
	 public void test() throws Exception {	
        ...
        driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS); 
			       ...
			       driver.switchTo().parentFrame();
			         ...
			         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
			         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top")); 
			       NewAssignee.orgname(driver).sendKeys("Deutsche Bank");
			       ...
			       NewAssignee.OrgResultDBClick(driver);
			       driver.manage().timeouts().implicitlyWait(2,TimeUnit.SECONDS); 
			       driver.switchTo().parentFrame();
			         driver.switchTo().parentFrame();
			         driver.switchTo().parentFrame();
			       ...
			       Thread.sleep(1000);
			       takeScreenshot(driver,"2.DB New Assignee Profile");
			       ...
			       takeScreenshot(driver,"3.DB New Assignee Profile");	
			       ...
			       takeScreenshot(driver,"4.DB New Assignee Profile");	
			       ...
			       NewAssignee.centerofexcellence(driver).selectByIndex(1);
			         ...
			         takeScreenshot(driver,"5.DB New Assignee Profile");		
			         ...
			         Thread.sleep(2000);
					  ...
					  driver.switchTo().defaultContent();
				         ...
				         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top")); 
				   		...
				   		Thread.sleep(1500);
				   		takeScreenshot(driver,"4.DB New Profile Completed");	
					  } else {
						     driver.switchTo().defaultContent();
				        	 driver.findElement(By.xpath("//input[@value='Yes']")).click();
				        	  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
			         ...
			         Thread.sleep(300);
			          ...
			          Thread.sleep(10000);
			          driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
			          WebElement element =   driver.findElement(By.xpath("//input[@name='cust_authorized_date']"));
				         Actions actions = new Actions(driver);
				         actions.moveToElement(element);
				         actions.perform();
				         takeScreenshot(driver,"5.DB New Profile Completed");
				         Thread.sleep(1500);
					  						 
				         WebElement    element1 =    driver.findElement(By.xpath("//input[@name='txtHostCitySearch']"));
				         Actions actions1 = new Actions(driver);
				         actions1.moveToElement(element1);
				         actions1.perform();
				         takeScreenshot(driver,"6.DB New Profile Completed");
				         Thread.sleep(1500); 
				         ...
				         actions2.perform();
				         takeScreenshot(driver,"7.DB New Profile Completed");
				         Thread.sleep(1500);
				         ...
				         actions3.perform();
				         takeScreenshot(driver,"8.DB New Profile Completed");
				         Thread.sleep(1500);
				         ...
				         actions4.perform();
				         takeScreenshot(driver,"9.DB New Profile Completed");
				         Thread.sleep(1500);
