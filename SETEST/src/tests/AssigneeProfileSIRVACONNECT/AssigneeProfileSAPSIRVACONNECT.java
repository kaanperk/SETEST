...
public class AssigneeProfileSAPSIRVACONNECT {
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/SIRVACONNECT-SAP/" + screenshotname + ".png"));
		} catch (Exception e) {
	...
	//	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	 ...
	 public void test() throws Exception {	
		...
		//  NewAssignee.previousgac(driver).selectByIndex(1);
		  ...
		  takeScreenshot(driver,"1. SAP Profile Completed");
