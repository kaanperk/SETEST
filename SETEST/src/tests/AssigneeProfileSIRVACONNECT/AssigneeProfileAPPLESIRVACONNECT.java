...
public class AssigneeProfileAPPLESIRVACONNECT{
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/SIRVACONNECT-APPLE/" + screenshotname + ".png"));
		} catch (Exception e) {
	 ...
	 public void test() throws Exception {	
		 ...
		 */
			       ...
			       NewAssignee.centerofexcellence(driver).selectByIndex(1);
					 ...
					 int i =1;
					 System.out.println("APPLE Profile");
