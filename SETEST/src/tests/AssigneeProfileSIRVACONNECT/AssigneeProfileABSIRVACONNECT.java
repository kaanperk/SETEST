...
import org.openqa.selenium.support.ui.WebDriverWait;
	...
	public class AssigneeProfileABSIRVACONNECT {
		...
		public void takeScreenshot(WebDriver driver, String screenshotname) {
			try {
				...
				FileUtils.copyFile(source, new File("./Screenshots/SIRVACONNECT-AllianceBernstein/" + screenshotname + ".png"));
			} catch (Exception e) {
...
//			    driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		 ...
		 */
			...
			NewAssignee.centerofexcellence(driver).selectByIndex(1);
			 ...
			 int i =1;
			 System.out.println("Alliance Bernstein Profile");
			...
			Thread.sleep(3000);
			takeScreenshot(driver, "1.ABProfile Completed");
