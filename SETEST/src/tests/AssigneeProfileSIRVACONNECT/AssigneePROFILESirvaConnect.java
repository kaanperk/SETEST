...
public class AssigneePROFILESirvaConnect {
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/SIRVACONNECT-GENERIC/" + screenshotname + ".png"));
		} catch (Exception e) {
	...
	//	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	 ...
	 public void test() throws Exception {	
        ...
        driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
		  ...
		  NewAssignee.custemail(driver).sendKeys("test123@sirva.com"); 
		  Thread.sleep(1500);
         ...
         Thread.sleep(2500);
		  ...
		  takeScreenshot(driver,"1. Generic Profile Completed");
