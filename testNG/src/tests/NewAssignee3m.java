        ...
        driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
			       ...
			       NewAssignee.OKClick(driver);
			        ...
			        NewAssignee.custhomecompany(driver).sendKeys("company name");
				      ...
				      Thread.sleep(1500);
				       takeScreenshot(driver,"2.3M New Assignee Profile");
			       ...
			       Thread.sleep(1500);
			       takeScreenshot(driver,"3.3M Profile1");	
			       ...
			       Thread.sleep(1500);
			       takeScreenshot(driver,"4.3M Profile2");	
			       ...
			       NewAssignee.centerofexcellence(driver).selectByIndex(1);
			         ...
			         Thread.sleep(1500);
			         takeScreenshot(driver,"5.3M Profile3");	
			         ...
			         driver.switchTo().parentFrame();
				         ...
				         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
						  ...
						  Thread.sleep(3000);
						  takeScreenshot(driver,"6.3M Profile Completed");
						  ...
						  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe")); 
					         ...
					         actions.perform();
					         takeScreenshot(driver,"7.3M Profile Completed");
					         Thread.sleep(1500);
					         ...
					         actions1.perform();
					         takeScreenshot(driver,"8.3M Profile Completed");
					         Thread.sleep(1500);
					         ...
					         actions2.perform();
					         takeScreenshot(driver,"9.3M Profile Completed");
					         Thread.sleep(1500);
					         ...
					         actions3.perform();
					         takeScreenshot(driver,"10.3M Profile Completed");
					         Thread.sleep(1500);
					         ...
					         actions4.perform();
					         takeScreenshot(driver,"11.3M Profile Completed");
					         Thread.sleep(1500);
