...
public class AssigneDetailReport3MTest{
	WebDriver driver; 
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/AssigneeDetail3MReport/" + screenshotname + ".png"));
		} catch (Exception e) {
	...
	public void test() throws Exception {
	   ...
	   /**LOGIN **/
	 	LoginPage.userid(driver).sendKeys("nancy.barreto@sirva.com");
	 	LoginPage.passwd(driver).sendKeys("Sirva123@@");
