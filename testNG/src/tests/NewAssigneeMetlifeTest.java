...
public class NewAssigneeMetlifeTest {
	...
	public void takeScreenshot(WebDriver driver, String screenshotname) {
		try {
			...
			FileUtils.copyFile(source, new File("./Screenshots/METLIFEPROFILE-Screenshots/" + screenshotname + ".png"));
		} catch (Exception e) {
			  ...
			  driver.switchTo().defaultContent();
		   	 ...
		   	 takeScreenshot(driver,"8.Metlife Profile Completed");	
				  ...
				  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe")); 
			         ...
			         actions.perform();
			         takeScreenshot(driver,"9.Metlife Profile Completed");	
			         Thread.sleep(1500);
			         ...
			         actions1.perform();
			         takeScreenshot(driver,"10.Metlife Profile Completed");	
				     Thread.sleep(1500);
			         ...
			         actions2.perform();
			         takeScreenshot(driver,"11.Metlife Profile Completed");	
			         Thread.sleep(1500);
			         ...
			         actions3.perform();
			         takeScreenshot(driver,"12.Metlife Profile Completed");	
			         Thread.sleep(1500);
			         ...
			         actions4.perform();
			         takeScreenshot(driver,"13.Metlife Profile Completed");	
			         Thread.sleep(1500);
