	 ...
	 public void test() throws Exception {	
        ...
        driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
			       ...
			       driver.switchTo().parentFrame();
			         ...
			         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
			         wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top")); 
			       NewAssignee.orgname(driver).sendKeys("20th");
			       driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
			       driver.switchTo().parentFrame();
		 ...
		 driver.switchTo().defaultContent();
	       ...
	       wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work")); 
	       wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top")); 
		 NewAssignee.DependentAddNewClick(driver);
		 Thread.sleep(6000);
		 driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
		 wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_appframe"));
		 wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work")); 
	     wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top"));   
	 	(new WebDriverWait(driver, 2))
		  .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='DependentWilAccom_2' and @value='Y']")));
		 ...
		 NewAssignee.dependent2lastname(driver).sendKeys("lastname");
		  ...
		  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("work_top"));
		  Thread.sleep(2000);
           takeScreenshot(driver,"12.Profile Completed");
				  Thread.sleep(1500);
				  ...
				  driver.switchTo().defaultContent();
				  Thread.sleep(1500);		  
				  takeScreenshot(driver,"13.Profile Completed");
				  Thread.sleep(1500);
				   driver.switchTo().defaultContent();
				  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("did_dmode_frame_1"));
				  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("frame_hdr"));
		  ...
		  WebElement element1 =  driver.findElement(By.xpath("//input[@name='home_hr_manager_email']"));
		  ...
		  WebElement element2 =  driver.findElement(By.xpath("//input[@name='dt_offer_acceptance_date']"));
		  Actions actions2 = new Actions(driver); 
		  actions2.moveToElement(element2);
		  actions2.perform(); takeScreenshot(driver,"15.Profile Completed");
		  Thread.sleep(1500);
		  
		  WebElement element3 =  driver.findElement(By.xpath("//textarea[@name='special_needs']")); Actions
		  actions3 = new Actions(driver); 
		  actions3.moveToElement(element3);
		  actions3.perform(); takeScreenshot(driver,"16.Profile Completed");
		  Thread.sleep(1500);
		  
		  WebElement element4 =  driver.findElement((By.xpath("//textarea[@name = 'cust_oth_special_needs_1']"))); 
		  ...
		  WebElement element5 =  driver.findElement((By.xpath("//textarea[@name = 'cust_oth_special_needs_2']"))); 
		  Actions actions5 = new Actions(driver);
		  actions5.moveToElement(element5); 
		  actions5.perform();
		  takeScreenshot(driver,"18.Profile Completed"); Thread.sleep(1500);
		  
		  WebElement element6 =  driver.findElement(By.xpath("//input[@name='cust_authorized_date']"));
		  Actions actions6 = new Actions(driver); 
		  actions6.moveToElement(element6);
		  actions6.perform(); takeScreenshot(driver,"19.Profile Completed");
		  Thread.sleep(1500);
		  
		  WebElement element7 =  driver.findElement(By.xpath("//input[@name='client_system_id']")); Actions
		  actions7 = new Actions(driver); 
		  actions7.moveToElement(element7);
		  actions7.perform(); 
		  takeScreenshot(driver,"20.Profile Completed");
		  Thread.sleep(1500);
